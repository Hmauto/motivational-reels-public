import {registerRoot, Composition, Series, Audio, staticFile, Sequence} from 'remotion';
...
registerRoot(() => (
  <Composition id="DisciplineEqualsFreedom" component={Video} durationInFrames={TOTAL_FRAMES} width={1080} height={1920} fps={30} />
));
